...
const Header: React.FC<HeaderProps> = ({ title, logoUrl, onClick, onToggle }) => {
  ...
  // مدیریت تغییر حالت منو
  const toggleApplicationMenu = () => {
    setApplicationMenuOpen(prev => !prev);
    if (onToggle) onToggle(); // اگر تابع از بیرون داده شده بود، صداش بزن
  };
...
//   const [scrolled, setScrolled] = useState(false);
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-200 lg:border-b">
