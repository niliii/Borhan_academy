...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Borhan Akademi - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Borhan Akademi - React.js Tailwind CSS Admin Dashboard Template"
      />
