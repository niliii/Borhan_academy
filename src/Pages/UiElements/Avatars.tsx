...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Borhan Akademi - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Borhan Akademi - React.js Tailwind CSS Admin Dashboard Template"
      />
