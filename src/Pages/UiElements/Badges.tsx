...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Borhan Akademi - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Borhan Akademi - React.js Tailwind CSS Admin Dashboard Template"
      />
